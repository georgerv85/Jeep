...
function Navbar2() {
  return (
    ...
    <div className='container-second' id='svg'>
        ...
        <ul className='navbar-second'>
          <li><Link to="1"><svg xmlns="http://www.w3.org/2000/svg" id='svg' width="16" height="16" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
            ...
            </svg>ΦΥΛΛΑΔΙΟ & ΤΙΜΟΚΑΤΑΛΑΓΟΣ</Link>
          </li>
          <li><Link to="2"><svg xmlns="http://www.w3.org/2000/svg" id='svg' width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
            <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10"/>
            <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
            </svg>ΔΙΚΤΥΟ ΔΙΑΝΟΜΕΩΝ</Link>
          </li>
          <li><Link to="3"><svg xmlns="http://www.w3.org/2000/svg" id='svg' width="16" height="16" fill="currentColor" class="bi bi-wrench" viewBox="0 0 16 16">
            <path d="M.102 2.223A3.004 3.004 0 0 0 3.78 5.897l6.341 6.252A3.003 3.003 0 0 0 13 16a3 3 0 1 0-.851-5.878L5.897 3.781A3.004 3.004 0 0 0 2.223.1l2.141 2.142L4 4l-1.757.364zm13.37 9.019.528.026.287.445.445.287.026.529L15 13l-.242.471-.026.529-.445.287-.287.445-.529.026L13 15l-.471-.242-.529-.026-.287-.445-.445-.287-.026-.529L11 13l.242-.471.026-.529.445-.287.287-.445.529-.026L13 11z"/>
            </svg>ΔΙΑΜΟΡΦΩΣΗ</Link>
          </li>
          <li><Link to="4"><svg xmlns="http://www.w3.org/2000/svg" id='svg' width="16" height="16" fill="currentColor" class="bi bi-browser-safari" viewBox="0 0 16 16">
          ...
          <li><Link to="5"><svg xmlns="http://www.w3.org/2000/svg" id='svg' width="16" height="16" fill="currentColor" class="bi bi-clipboard2-check" viewBox="0 0 16 16">
            <path d="M9.5 0a.5.5 0 0 1 .5.5.5.5 0 0 0 .5.5.5.5 0 0 1 .5.5V2a.5.5 0 0 1-.5.5h-5A.5.5 0 0 1 5 2v-.5a.5.5 0 0 1 .5-.5.5.5 0 0 0 .5-.5.5.5 0 0 1 .5-.5z"/>
            <path d="M3 2.5a.5.5 0 0 1 .5-.5H4a.5.5 0 0 0 0-1h-.5A1.5 1.5 0 0 0 2 2.5v12A1.5 1.5 0 0 0 3.5 16h9a1.5 1.5 0 0 0 1.5-1.5v-12A1.5 1.5 0 0 0 12.5 1H12a.5.5 0 0 0 0 1h.5a.5.5 0 0 1 .5.5v12a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5z"/>
            <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0z"/>
            </svg>ΛΑΒΕΤΕ ΠΡΟΣΦΟΡΑ</Link>
          </li>
        </ul>
